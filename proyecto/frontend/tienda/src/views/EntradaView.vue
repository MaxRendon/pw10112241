    ...
    <div class="container py-5 h-100">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="card-body p-5 text-center">
                ...
                <button @click.prevent="registroGoogle()" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block" type="submit">
                    <Icon icon="logos:google-icon" /> Google</button>
                <button @click.prevent="registro()" class="btn btn-primary btn-lg btn-block" type="submit">Entrar</button>
